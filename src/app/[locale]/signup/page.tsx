          ...
          <div className="w-full max-w-md mx-auto space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                <label className="text-sm font-semibold text-text-main">{t("nameLabel")}</label>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <MailIcon className="h-5 w-5 text-text-light" />
                  </div>
                  <input 
                    type="email" 
                    name="email"
              ...
              <button 
                type="submit" 
                disabled={isPending}
                className="w-full mt-2 bg-brand-primary text-white font-bold rounded-xl py-3.5 hover:bg-brand-primary/90 transition-all shadow-lg shadow-brand-primary/20 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
              >
